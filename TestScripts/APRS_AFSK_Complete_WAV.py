...
import APRS_AFSK_Complete_WAV_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
...
class APRS_AFSK_Complete_WAV(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "APRS - AFSK Decoder (Test)", catch_exceptions=True)
        ...
        self.mark = mark = 1200
        self.gmu = gmu = 0.1
        self.bpf = bpf = firdes.band_pass(1.0, samp_rate, 1e3, 2.6e3, 100.0, window.WIN_BLACKMAN, 6.76)
        self.baud = baud = 1200
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\gr-APRS\\WAV\\aprs_random.wav', True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_hdlc_deframer_bp_0, 'out'), (self.epy_block_0_0, 'hdlc in'))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_bpf(firdes.band_pass(1.0, self.samp_rate, 1e3, 2.6e3, 100.0, window.WIN_BLACKMAN, 6.76))
